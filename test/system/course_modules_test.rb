...
class CourseModulesTest < ApplicationSystemTestCase
  ...
  test "creating a Course module" do
    ...
    fill_in "Modulecode", with: @course_module.ModuleCode
    fill_in "Moduleleader", with: @course_module.ModuleLeader
    fill_in "Moduleleaderid", with: @course_module.ModuleLeaderID
    fill_in "Moduleoverview", with: @course_module.ModuleOverview
