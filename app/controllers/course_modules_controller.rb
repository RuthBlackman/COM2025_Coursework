class CourseModulesController < ApplicationController
  ...
  def new
    ...
    redirect_to course_modules_url #redirect to the page of modules as the user should not be able to edit a module
  end
  ...
  private
    ...
    def course_module_params
      params.require(:course_module).permit(:Title, :ModuleCode, :ModuleOverview, :ModuleLeader, :ModuleLeaderID, :Credits, :Year)
    end
end
